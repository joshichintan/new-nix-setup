# Generated by Powerlevel10k configuration wizard on 2025-10-17 at 13:55 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale|utun|tun[0-9]*|tap[0-9]*)[0-9]*|(zt.*)'
